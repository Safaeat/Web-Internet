...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        for ($i = 0; $i < count($productNames); $i++) {
            ...
            $checkStockQuery = "SELECT quantity FROM stock WHERE productName = '$productName'";
            ...
            if ($result->num_rows > 0) {
                ...
                if ($quantity <= $currentStock) {
                    ...
                    echo '<script type="text/javascript">
                        window.onload = function () { alert("Not enough stock for product: ' . $productName . '"); } 
                     </script>';
                }
            } else {
                echo '<script type="text/javascript">
                    window.onload = function () { alert("Product not found in stock: ' . $productName . '"); } 
                 </script>';
            }
        }
        ...
        echo '<script type="text/javascript">
            window.onload = function () { alert("Products sell Successfully ."); } 
         </script>';
    }
    ?>
